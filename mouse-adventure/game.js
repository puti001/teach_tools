...
function header(){area.innerHTML='';area.className='play-area stage-'+stage;next.classList.add('hidden');$('#stage-label').textContent=`第 ${stage} 關 / 4`;document.querySelectorAll('.dots i').forEach((x,i)=>x.classList.toggle('active',i<stage));combo=0;$('#combo').textContent=0}
...
function load(){header();[stars,bubbles,bugs,apples][stage-1]()}
function home(){
